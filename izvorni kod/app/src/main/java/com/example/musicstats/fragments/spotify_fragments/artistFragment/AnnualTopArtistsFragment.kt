...
class AnnualTopArtistsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_annual_top_artists, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //check if accessToken has expired, refresh accordingly
        if (accessToken != null) {
            ...
            try{
                ...
                artistResponse.enqueue(object: Callback<SpotifyArtistModel>{
                    override fun onResponse(
                        ...
                        try{
                            val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerViewAnnualArtists)
