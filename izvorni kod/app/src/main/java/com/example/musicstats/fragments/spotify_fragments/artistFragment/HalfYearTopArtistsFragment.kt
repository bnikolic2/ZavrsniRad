...
class HalfYearTopArtistsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_half_year_top_artists, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //check if accessToken has expired, refresh token accordingly
        if (accessToken != null) {
        ...
        //get data for medium term (6 months)
            ...
            try{
                ...
                artistResponse.enqueue(object: Callback<SpotifyArtistModel>{
                    override fun onResponse(
                        ...
                        try{
                            val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerViewHalfYearArtists)
